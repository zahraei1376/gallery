...
import {
    PopUpContainer, TextArea, PopUpBody, ContentFile, Form, MyCloseIcon, Group, Lable, Input, SettingIcon,
    ContentContainer, BtnClose, LogoContainer, Title, PopUpHeader, FileContainer, MyImage, ImageWrapper,
} from './popupUpload.styles';
...
const PopUpUpload = ({ setShowUploadBox, currentUser, close, refreshData, setTriggerDeleteFile, triggerDeleteFile, }) => {
